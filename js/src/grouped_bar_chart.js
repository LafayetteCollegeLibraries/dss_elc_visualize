...
(function($) {
    ...
    /**
     * Function for rendering the legend for the samples
     * @param [jQuery Object] target
     * @param [Array] sampleGroups An array of samples
     * @param [Object] margin
     * @param [D3 Domain] colors The color map for the legend
     */
	...
	if(true) {
	    ...
	    */
	    ...
	    /**
	     * This modification appeared to be necessary for univariate analyses
	     * @todo Refactor?
	     */
	    ...
	    //sampleGroups = data.map(function(e) { return e.values[0].sample });
